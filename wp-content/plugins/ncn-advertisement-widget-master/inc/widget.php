...
class ncnaw_advertisement_widget extends WP_Widget {
   ...
   function __construct() {
      $widget_ops = array( 'classname' => 'ncnaw_widget_advertisement', 'description' => __( 'Thêm quảng cáo của bạn ở đây', 'thanhnh') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::__construct( false,$name= __( 'NHT: Quảng cáo', 'thanhnh' ),$widget_ops);
   }
   ...
   function form( $instance ) {
      ...
      <p>
         <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Tiêu đề:', 'thanhnh' ); ?></label>
      ...
      <p>
         <label for="<?php echo esc_attr( $this->get_field_id( $image_link ) ); ?>"> <?php esc_html_e( 'Liên kết đích đến của quảng cáo:', 'thanhnh' ); ?></label>
      ...
      <p>
         <label for="<?php echo esc_attr( $this->get_field_id( $image_url ) ); ?>"> <?php esc_html_e( 'Hình ảnh quảng cáo:', 'thanhnh' ); ?></label>
         ...
         <input type="button" class="button button-primary custom_media_button" id="custom_media_button" name="<?php echo esc_attr( $this->get_field_name( $image_url ) ); ?>" value="<?php esc_attr_e( 'Upload ảnh', 'thanhnh' ); ?>" style="margin-top:5px;" onclick="imageWidget.uploader( '<?php echo esc_js( $this->get_field_id( $image_url ) ); ?>' ); return false;"/>
      </p>
   <?php }
