...
load_plugin_textdomain( 'thanhnh', false, NCNAW_DIR_PATH . '/languages' );
...
function ncnaw_enqueue_script() {
	wp_enqueue_media();
	wp_enqueue_script( 'thanhnh-image-uploader', NCNAW_DIR_URL . '/js/image-uploader.js', array(), '1.0.0', true );
}
