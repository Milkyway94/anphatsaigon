				...
				if ( $items ) {
					...
					if ( $this->options['show_toc_in_widget_only'] && (in_array(get_post_type(), $this->options['show_toc_in_widget_only_post_types'])) ) {
						...
						if ( $this->options['show_heading_text'] ) {
							...
							$html .= '<p class="toc_title"><i id="ftocp-button-icon" class="ftoc-icon ftoc-icon-list-number ftoc-icon-normal"></i>' . htmlentities( $toc_title, ENT_COMPAT, 'UTF-8' ) . '&nbsp;<i class="fa fa-times"></i></p>';
						}
