...
<div class="item w100 fl">
	<div class="image w100 fl content-left-dst">
		...
		<img class="img-responsive" border="0" src="<?php echo site_url().'/timthumb.php?src='.$thumbnail_URL.'&w=258&h=180&q=100'; ?>"alt="<?php the_title(); ?>">
	...
	<div class="content-right-dst">
		...
		<div class="description w100 fl"> 
			<?php echo substr(get_the_excerpt(), 0,300); ?> <a href="<?php the_permalink();  ?>">[…]</a>
		</div>       
	</div>  
</div>